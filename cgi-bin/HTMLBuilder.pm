...
my %SELECT_LISTS = (assigned_to=>["Ederer", "Alroy"],
					...
					collection_type=>['', 'biostratigraphic', 'paleoecologic', 'taphonomic', 'taxonomic'],
					...
					mapcontinent=>['global', 'Africa', 'Antarctica', 'Asia (north)', 'Asia (south)', 'Australia', 'Europe', 'North America', 'South America'],
					mapscale=>['X 2.5', 'X 3', 'X 4', 'X 5'],
					mapbgcolor=>[ 'blue', 'red', 'yellow', 'black', 'gray', 'white', 'green', 'orange', 'teal', 'violet'],
					gridsize=>['30 degrees', '15 degrees', '10 degrees', 'none'],
					gridcolor=>[ 'blue', 'red', 'yellow', 'black', 'gray', 'white', 'green', 'orange', 'teal', 'violet'],
					coastlinecolor=>[ 'blue', 'red', 'yellow', 'black', 'gray', 'white', 'green', 'orange', 'teal', 'violet'],
					pointshape=>['small circles', 'medium circles', 'large circles', 'proportional circles', 'small squares', 'medium squares', 'large squares', 'proportional squares'],
					dotcolor=>[ 'blue', 'red', 'yellow', 'black', 'gray', 'white', 'green', 'orange', 'teal', 'violet'],
