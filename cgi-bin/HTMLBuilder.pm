...
my %SELECT_LISTS = (assigned_to=>["Ederer", "Alroy"],
                    ...
                    lithadj=>['', 'lenticular', 'tabular', 'desiccation cracks', 'current ripples', 'dunes', 'hummocky CS', 'wave ripples', '"cross stratification"', 'planar lamination', 'tool marks', 'flute casts', 'deformed bedding', 'grading', 'burrows', 'bioturbation', 'pedogenic', '', 'condensed', 'firmground', 'hardground', 'lag', '', 'argillaceous', 'micaceous', 'silty', 'sandy', 'conglomeratic', 'pebbly', '', 'calcareous', 'carbonaceous', 'cherty/siliceous','concretionary', 'diatomaceous', 'dolomitic', 'ferruginous', 'glauconitic', 'gypsiferous', 'hematitic', 'pyritic', 'phosphatic', 'sideritic', 'stromatolitic', 'tuffaceous', 'volcaniclastic', '', 'flat-pebble', 'intraclastic', 'oncoidal', 'ooidal', 'peloidal', 'shelly/skeletal', '', 'black', 'blue', 'brown', 'gray', 'green', 'red', 'red or brown', 'white', 'yellow'], 
					...
					research_group=>['', 'marine invertebrate', 'paleobotany', 'paleoentomology', 'taphonomy', 'vertebrate', 'ETE', '5%', 'PACED', 'PGAP'],
					eml_interval=>['', 'Late/Upper', 'Middle', 'Early/Lower'],
					eml_max_interval=>['', 'Late/Upper', 'Middle', 'Early/Lower'],
					eml_min_interval=>['', 'Late/Upper', 'Middle', 'Early/Lower'],
					...
					scale_rank=>['period/system', 'epoch/series', 'age/stage', 'chron/zone'],
