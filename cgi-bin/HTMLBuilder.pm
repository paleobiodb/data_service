...
my %SELECT_LISTS = (assigned_to=>["Ederer", "Alroy"],
					...
					gps_datum=>['','NAD27','NAD83','WGS72','WGS84'],
					...
					ecology1=>['','composition1','composition2','size_value','size_unit','thickness','architecture','form','reinforcement','folds','ribbing','spines','polymorph','ontogeny','grouping','clonal','environment','locomotion','attached','epibiont','life_habit','diet1','diet2','reproduction','dispersal1','dispersal2'],
					ecology2=>['','composition1','composition2','size_value','size_unit','thickness','architecture','form','reinforcement','folds','ribbing','spines','polymorph','ontogeny','grouping','clonal','environment','locomotion','attached','epibiont','life_habit','diet1','diet2','reproduction','dispersal1','dispersal2'],
					ecology3=>['','composition1','composition2','size_value','size_unit','thickness','architecture','form','reinforcement','folds','ribbing','spines','polymorph','ontogeny','grouping','clonal','environment','locomotion','attached','epibiont','life_habit','diet1','diet2','reproduction','dispersal1','dispersal2'],
					...
					environment=>['', 'hypersaline','marine','brackish','freshwater','terrestrial'],
