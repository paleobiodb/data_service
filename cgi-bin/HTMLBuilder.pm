...
my %SELECT_LISTS = (assigned_to=>["Ederer", "Alroy"],
					...
					research_group=>['', 'marine invertebrate', 'paleobotany', 'paleoentomology', 'taphonomy', 'vertebrate', 'ETE', '5%', 'PGAP'],
