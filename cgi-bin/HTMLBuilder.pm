...
# my @colorlist = /"black", "gray", "white", "pink", "red", "brown", "ochre", "orange", "yellow", "green", "emerald", "teal", "blue", "violet", "purple"/;
my $colorlist = "'black', 'gray', 'white', 'pink', 'red', 'brown', 'ochre', 'orange', 'yellow', 'green', 'emerald', 'teal', 'blue', 'violet', 'purple'";
...
my %SELECT_LISTS = (assigned_to=>["Ederer", "Alroy"],
					...
					oceancolor=>[ 'black', 'gray', 'white', 'pink', 'red', 'brown', 'ochre', 'orange', 'yellow', 'green', 'emerald', 'teal', 'blue', 'violet', 'purple' ],
					...
					pointsize=>['small', 'medium', 'large', 'proportional'],
					pointshape=>['circles', 'squares', 'triangles'],
