...
sub initialize {
	...
	{ output => 'taxon_rank', dwc_name => 'taxonRank', com_name => 'rnk', data_type => 'mix' },
	    ...
	    "See L<List of taxonomic ranks|node:general/taxon_ranks> for a list of",
	    "ranks and corresponding numeric codes.",
	...
	{ output => 'taxon_rank', dwc_name => 'taxonRank', com_name => 'rnk', data_type => 'mix' },
	    ...
	    "to kingdom. See L<List of taxonomic ranks|node:general/taxon_ranks> for a",
	    "list of ranks and corresponding numeric codes.",
	{ output => 'taxon_name', dwc_name => 'scientificName', com_name => 'nam' },
	...
	{ output => 'taxon_rank', dwc_name => 'taxonRank', com_name => 'rnk' },
	    "The taxonomic rank of this name. See",
	    "L<List of taxonomic ranks|node:general/taxon_ranks> for a list of ranks",
	    "and corresponding numeric codes.",
	{ output => 'taxon_name', dwc_name => 'scientificName', com_name => 'nam' },
	    "The scientific name of this taxon",
	...
	{ select => [ 'p.image_no', 'p.uid', 'p.created', 'p.modified', 
		      'p.credit', 'p.attribution', 'p.license' ] },
	...
	{ output => 'taxon_rank', com_name => 'rnk', data_type => 'mix' },
	    ...
	    "this opinion. See L<List of taxonomic ranks|node:general/taxon_ranks> for",
	    "a list of ranks and corresponding numeric codes.",
	...
	{ value => 'certain' },
	    ...
	    "and for subspecies C<var> / C<forma> / C<morph> / C<mut>.",
	{ value => 'genus_certain' },
	    "Like C<B<certain>>, but look only at the genus/subgenus and ignore species",
	    "and subspecies modifiers.",
	{ value => 'uncertain' },
...
sub get_image {
	...
	if ( $taxon_no =~ /^N[A-Z]$/ )
	{
	    push @clauses, "uid = 'INVALID_TAXON'";
	}
