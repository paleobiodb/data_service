...
#	    "established by the L<Earthbyte Group|http://www.earthbyte.org/>.");
	...
	{ value => 'any' },
	    "Select all identifications of every occurrence that matches the other",
	    "parameters specified in this request. If a taxonomic name is specified",
	    "this may include identifications that don't fall under that name.",
	{ value => 'reid' },
...
#	    "Show all of these");
	...
	{ optional => 'idmod', valid => ANY_VALUE },
	    ...
	    "=over",
	    "=item ng", "n. gen. / n. subgen.", "=item ns", "n. sp. / n. ssp.",
	    ...
	    "=item va", "var", "=item fo", "forma", "=item mo", "morph", "=item mu", "mut",
...
$ETVALUE{silicic} = {'marginal marine indet.' => 1, 'coastal indet.' => 1, 'estuary/bay' => 1, 'lagoonal' => 1, 'paralic indet.' => 1, 'delta plain' => 1, 'interdistributary bay' => 1, 'delta front' => 1, 'prodelta' => 1, 'deltaic indet.' => 1, 'foreshore' => 1, 'shoreface' => 1, 'transition zone/lower shoreface' => 1, 'offshore' => 1, 'coastal indet.' => 1, 'submarine fan' => 1, 'basinal (siliciclastic)' => 1 };
