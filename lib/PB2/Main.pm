...
#     $ds2->define_path({ path => 'strata',
# 			class => 'Data_1_1::CollectionData',
# 			doc_title => 'Geological strata' });
    
#     $ds2->define_path({ path => 'strata/list',
# 			method => 'strata',
# 			output => '1.1:colls:strata' });
    
#     $ds2->define_path({ path => 'strata/auto',
# 			method => 'strata',
# 			arg => 'auto',
# 			output => '1.1:colls:strata',
...
#     $ds2->define_path({ path => 'taxa',
# 			class => 'Data_1_1::TaxonData',
# 			output => '1.1:taxa:output_map',
# 			doc_title => 'Taxonomic names' });
    
#     $ds2->define_path({ path => 'taxa/single',
# 			allow_format => '+xml',
# 			allow_vocab => '+dwc',
# 			method => 'get',
# 			doc_title => 'Single taxon' });
    
#     $ds2->define_path({ path => 'taxa/list',
# 			allow_format => '+xml',
# 			allow_vocab => '+dwc',
# 			method => 'list',
# 			doc_title => 'Lists of taxa' });
    
#     $ds2->define_path({ path => 'taxa/refs',
# 			output => '1.1:refs:output_map',
# 			method => 'list',
# 			arg => 'refs',
# 			doc_title => 'Bibliographic references for taxa' });
    
#     $ds2->define_path({ path => 'taxa/match',
# 			method => 'match' });
    
#     $ds2->define_path({ path => 'taxa/auto',
# 			method => 'auto', 
# 			allow_format => 'json',
# 			output => '1.1:taxa:auto_map',
# 			doc_title => 'Auto-completion for taxonomic names' });
    
#     $ds2->define_path({ path => 'taxa/thumb',
# 			allow_format => '+png',
...
#     $ds2->define_path({ path => 'taxa/icon',
# 			allow_format => '+png',
# 			output => '1.1:taxa:imagedata',
# 			method => 'get_image',
# 			arg => 'icon',
...
#     $ds2->define_path({ path => 'taxa/list_images',
# 			output => '1.1:taxa:imagedata',
# 			method => 'list_images',
...
#     $ds2->define_path({ path => 'common',
# 			ruleset => '1.1:common_params',
# 			doc_title => 'common parameters' });
    
#     $ds2->define_path({ path => 'datetime',
# 			doc_title => 'Selecting records by date and time' });
    
#     $ds2->define_path({ path => 'formats',
# 			doc_title => 'Formats and Vocabularies' });
    
#     $ds2->define_path({ path => 'formats/json',
# 			doc_title => 'JSON format' });
    
#     $ds2->define_path({ path => 'formats/xml',
# 			doc_title => 'XML format' });
    
#     $ds2->define_path({ path => 'formats/text',
# 			doc_title => 'Text formats' });
    
#     $ds2->define_path({ path => 'formats/ris',
# 			doc_title => "RIS format" });
    
#     $ds2->define_path({ path => 'formats/png',
# 			doc_title => 'PNG format' });
    
    
    # And finally, stylesheets and such
    
    $ds2->define_path({ path => 'css',
			file_dir => 'public/css',
			send_files => 1 });
