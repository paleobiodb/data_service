...
sub initialize {
	...
	{ value => 'attr' },
	    "Show the attribution of the reference, which is composed of the first",
	    "and possibly the second authors.",
	...
	tables => ['r'] },
      ...
      { set => 'attribution', from => '*', code => \&format_authors, if_block => 'attr' },
	...
	not_block => 'formatted', not_vocab => 'bibjson', not_block => 'authorlist' },
      ...
      { output => 'attribution', com_name => 'atr', if_block => 'attr' },
	  "The attribution of the reference, consisting of the first and possibly",
	  "the second author name.",
