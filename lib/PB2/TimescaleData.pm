...
sub initialize {
	...
	{ output => 'age', com_name => 'age', data_type => 'dec' },
	    "The age at which this boundary is fixed or calculated, in Ma",
	{ output => 'age_error', com_name => 'ger', data_type => 'dec' },
	...
	{ output => 'is_different', com_name => 'dif', data_type => 'pos' },
