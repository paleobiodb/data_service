...
sub initialize {
	...
	{ value => 'full', maps_to => '1.2:specs:full_info' },
	    ...
	    "B<geo>, B<methods>, B<env>, B<rem>, B<refattr>.  If we subsequently add new data fields to the",
	...
	{ value => 'prot', maps_to => '1.2:colls:prot' },
	    "Whether or not the specimen was found on protected land",
