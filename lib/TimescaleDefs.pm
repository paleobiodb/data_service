...

{
    ...
    set_column_property('TIMESCALE_BOUNDS', 'base_no', FOREIGN_TABLE => 'TIMESCALE_BOUNDS');
    set_column_property('TIMESCALE_BOUNDS', 'base_no', FOREIGN_KEY => 'bound_no');
    set_column_property('TIMESCALE_BOUNDS', 'range_no', EXTID_TYPE => 'BND');
    set_column_property('TIMESCALE_BOUNDS', 'range_no', FOREIGN_TABLE => 'TIMESCALE_BOUNDS');
    set_column_property('TIMESCALE_BOUNDS', 'range_no', FOREIGN_KEY => 'bound_no');
    set_column_property('TIMESCALE_BOUNDS', 'top_no', EXTID_TYPE => 'BND');
    set_column_property('TIMESCALE_BOUNDS', 'top_no', FOREIGN_TABLE => 'TIMESCALE_BOUNDS');
    set_column_property('TIMESCALE_BOUNDS', 'top_no', FOREIGN_KEY => 'bound_no');
    set_column_property('TIMESCALE_BOUNDS', 'color_no', EXTID_TYPE => 'BND');
    set_column_property('TIMESCALE_BOUNDS', 'color_no', FOREIGN_TABLE => 'TIMESCALE_BOUNDS');
    set_column_property('TIMESCALE_BOUNDS', 'color_no', FOREIGN_KEY => 'bound_no');
    
    set_table_property('TIMESCALE_INTS', CAN_MODIFY => 'ADMIN');
    set_table_property('TIMESCALE_INTS', ALLOW_DELETE => 1);
