...
sub initialize {
	...
	{ value => 'coords', maps_to => '1.1:occs:geo' },
	    ...
	    "Additional information about the geographic locality of the containing collection",
	...
	{ value => 'stratext', maps_to => '1.1:colls:stratext' },
	    "Detailed information about the stratigraphic context of the collection.",
	...
	{ select => ['o.occurrence_no', 'o.collection_no',
		     'o.taxon_no as actual_no', 'a.taxon_name as actual_name', 
	...
	{ output => 'taxon_name', com_name => 'tna', dwc_name => 'associatedTaxa' },
	    "The taxonomic name with which this occurrence has been identified, with synonymy taken into account.",
	...
	{ output => 'taxon_no', com_name => 'tid' },
	    "The unique identifier of the taxonomic name.",
	{ output => 'actual_name', com_name => 'atn', dedup => 'taxon_name' },
	    "The actual taxonomic name with which this occurrence has been identified, regardless of synonymy",
