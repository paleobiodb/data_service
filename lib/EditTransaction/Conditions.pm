...
our (%CONDITION_BY_CLASS) = ( EditTransaction => {
		...
		E_NO_KEY => { link => "This operation requires a linking key",
			      operation => ["The &2 operation requires a primary key value or a selection expression", "This operation requires a primary key value"],
		...
		E_NOT_FOUND => { link => ["Linked record '&2' was not found",
