...
var timeScale = {
  "init": function(div) {
    ...
    d3.json("/data1.1/intervals/list.json?order=older&max_ma=4000", function(error, result) {
  ...
  "resize": function() {
    d3.select(".timeScale g")
      .attr("transform", function() {
        var width = parseInt(d3.select("#graphics").style("width")) - 30;
    ...
    d3.select(".timeScale svg")
      .style("width", function() {
        return (parseInt(d3.select("#graphics").style("width")) - 29);
       })
      .style("height", function() {
        return (box.height + 20) + "px";
      });
  }
}