...
subtest 'basic' => sub {
    ...
    ok( $result, "first replace was valid" ) || $T->diag_errors('current');
    
    $result = $edt->replace_record('EDT_AUX', { aux_no => $aux_keys[1], name => 'replaced a', test_no => '@x1' });
    
    ok( $result, "second replace was valid" ) || $T->diag_errors('current');
    
    $result = $edt->replace_record('EDT_AUX', { aux_no => $aux_keys[2], name => 'replaced b' });
    
    ok( $result, "third replace was valid" ) || $T->diag_errors('current');
