...
# 
# new-edt : Test the creation of transaction instances by the 'new_edt' method of
#           EditTester.
# 
...
use ETBasicTest;
use ETTrivialClass;
use TableDefs qw(set_table_name);
...
subtest 'new_edt bad arguments' => sub {
    ...
    ok( $T->last_edt->has_condition('E_BAD_TABLE'), "bad table name generated an error" );
};
